...
- **Docker Desktop**: You can download and install Docker Desktop from Docker's official website : https://www.docker.com/products/docker-desktop/
- **Git**: You can download and install Git from Git's official website : https://git-scm.com/downloads
...
```bash
git clone https://github.com/yourusername/car_data_analysis_project.git
```
...
Open your web browser and go to `http://localhost:3838` to access the Shiny app.
